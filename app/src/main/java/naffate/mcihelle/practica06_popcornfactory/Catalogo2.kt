...
import kotlinx.android.synthetic.main.activity_detalle_pelicula2.view.*
...
class Catalogo2 : AppCompatActivity() {
    ...
    var adapterS: Catalogo2.SerieaAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cargarSeries()
        adapterS = Catalogo2.SerieaAdapter(series, this)
    ...
    fun cargarPeliculas() {
        peliculas.add(Pelicula("Big Hero 6", R.drawable.bighero6,
                R.drawable.headerbighero6, "When a devastating event befalls the city of San Fransokyo and catapults Hiro into the\n" +
                        ...
                        "&quot;Big Hero 6.&quot;"))
        peliculas.add(
            Pelicula("1917", R.drawable.guerra, R.drawable.guerraheader, "British trenches somewhere in France. World war has been going on for the third year,\n" +
    ...
    class SerieaAdapter : BaseAdapter {


        var series = ArrayList<Pelicula>()
        var context2: Context? = null

        constructor(peliculas: ArrayList<Pelicula>, context2: Context?) : super() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var inflator = context2!!.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            var vista = inflator.inflate(R.layout.pelicula, null)
            vista.iv_peliculas.setImageResource(pelicula.image)
            vista.tv_titulo.setText(pelicula.Nombre)

            vista.iv_peliculas.setOnClickListener() {
                var intent = Intent(context2, DetallePelicula2::class.java)
                intent.putExtra("Nombre", pelicula.Nombre)
                intent.putExtra("image", pelicula.image)
                intent.putExtra("header", pelicula.header)
                intent.putExtra("sinopsis", pelicula.sinopsis)
